...
$_SG['banco'] = 'bdcompras';            // Banco de dados MySQL
$_SG['paginaLogin'] = 'login.php'; // Página de login
$_SG['tabela'] = 'email';       // Nome da tabela onde os usuários são salvos
// ==============================
// ======================================
...
function validaUsuario($email, $senha) {
  ...
  $sql = "SELECT `id`, `nome` FROM `".$_SG['tabela']."` WHERE ".$cS." `email` = '".$nemail."' AND ".$cS." `senha` = '".$nsenha."' LIMIT 1";
